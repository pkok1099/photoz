...
class Bip39MnemonicGenerator
	...
	constructor(
		...
		private val wordlist: List<String> by lazy {
			context.resources
				.openRawResource(R.raw.bip39_english)
				.bufferedReader()
				.readLines()
		 ...
		 */
		fun entropyToMnemonic(entropy: ByteArray): List<String> = entropyToWords(entropy, wordlist)
	}
