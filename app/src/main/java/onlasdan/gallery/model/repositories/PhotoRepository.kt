...
class PhotoRepository
	...
	constructor(
		...
		/**
		 * (roadmap #1) — QtFastStart: MP4 MOOV relocation for progressive video streaming.
		...
		suspend fun safeImportPhoto(
			...
			// (roadmap #1) — QtFastStart: relocate MOOV atom for MP4/MOV videos
			...
			// F-BACK-011: Clean up faststart temp file in try/finally so it's
			// deleted even if safeCreatePhoto throws (was: leak on exception).
