...
object AppModule {
        ...
        /**
         * Sprint 8 / TODO #15 — TFLite tag extractor for semantic search.
         * TfliteTagExtractor checks if model file exists internally;
         * returns null tags if model not downloaded yet.
         * @since Sprint 8 — TFLite activation
         */
        @Provides
        @Singleton
        fun provideTagExtractor(): onlasdan.gallery.model.io.TagExtractor =
                onlasdan.gallery.model.io.TfliteTagExtractor()
}
