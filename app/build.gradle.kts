...
dependencies {
        ...
        // ─── TFLite — on-device semantic search (Sprint 8 / TODO #15) ──────────
        // MobileNet V2 model for image classification. Model file is NOT bundled
        // in APK (saves ~5MB) — user downloads it from Settings → Semantic Search.
