...
ktlint {
        ...
        // violations auto-fixed). Remaining ~10 violations are non-auto-fixable
        // (KDoc duplication, 1 spacing edge case) — left for gradual manual cleanup.
        // CI runs ktlintCheck as non-blocking for visibility; detekt is the
        // blocking quality gate.
        // TODO: set to false after manual KDoc cleanup (Sprint 4 follow-up)
